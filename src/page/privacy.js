  ...
  return (
    <>
      ...
      <main style={{ padding: '3rem 2rem', maxWidth: '800px', margin: '0 auto', fontFamily: 'sans-serif', lineHeight: '1.6' }}>
        ...
        <h2 style={{color : "4f46e5"}}> 1. 수집하는 정보</h2>
        <p>소환사 이름과 태그 등 공개 게임 데이터만을 수집합니다. 개인을 식별할 수 있는 정보는 저장하지 않습니다.</p>

        <h2 style={{color : "4f46e5"}}> 2. 정보 이용 목적</h2>
        <p>수집된 데이터는 팀 구성 추천 및 통계 분석에 사용됩니다.</p>

        <h2 style={{color : "4f46e5"}}> 3. 제3자 제공</h2>
        <p>사용자 정보를 제3자와 공유하거나 판매하지 않습니다.</p>

        <h2 style={{color : "4f46e5"}}> 4. 쿠키 사용</h2>
        <p>웹사이트 성능 개선을 위해 쿠키를 사용할 수 있습니다.</p>

        <h2 style={{color : "4f46e5"}}> 5. 정책 변경</h2>
