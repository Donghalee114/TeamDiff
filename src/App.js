...
import SearchPlayerInputPage from './page/SerachPlayerInputPage';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/SearchPlayerInfo" element={<SearchPlayerInputPage />} />
        <Route path="/SearchPlayerInfo/:summonerNameAndTag" element={<SearchPlayerInfo />} />
